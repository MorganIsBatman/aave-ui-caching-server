...
const CONFIGS: {
  ...
  [ChainId.mainnet]: {
    ...
    POOL_UI_DATA_PROVIDER_ADDRESS: '0xa2DC1422E0cE89E1074A6cd7e2481e8e9c4415A6',
    UI_INCENTIVE_DATA_PROVIDER_ADDRESS: '0xD01ab9a6577E1D84F142e44D49380e23A340387d',
  ...
  [1666600000]: { // harmony
    BLOCK_NUMBER_POOLING_INTERVAL: 5000,
    PROTOCOL_ADDRESSES_PROVIDER_ADDRESSES: ['0x43331337181Cac2B678FFcAd9553A0b377C15C0C'], // LendingPoolAddressesProvider
    PROTOCOLS_WITH_INCENTIVES_ADDRESSES: [''],
    POOL_UI_DATA_PROVIDER_ADDRESS: '0xf074421ADa291E5f683f793767d2e860c69E466B', // UiPoolDataProvider
