...
var commonContractAddressBetweenMarketsV2 = (_commonContractAddres = {}, _commonContractAddres[Network.kovan] = {
...
}, _commonContractAddres[Network.ropsten] = {
  SYNTHETIX_PROXY_ADDRESS: '',
  ...
  INCENTIVES_CONTROLLER: '',
  INCENTIVES_CONTROLLER_REWARD_TOKEN: ''
}, _commonContractAddres[Network.mainnet] = {
...
}, _commonContractAddres[Network.polygon] = {
  SYNTHETIX_PROXY_ADDRESS: '',
  GOVERNANCE_PROTO_CONTRACT: '',
  LEND_TO_AAVE_MIGRATOR: '',
...
}, _commonContractAddres[Network.mumbai] = {
  SYNTHETIX_PROXY_ADDRESS: '',
  GOVERNANCE_PROTO_CONTRACT: '',
  LEND_TO_AAVE_MIGRATOR: '',
...
var distinctContractAddressBetweenMarketsV2 = (_distinctContractAddr = {}, _distinctContractAddr[Market.Proto] = (_Market$Proto = {}, _Market$Proto[Network.kovan] = {
  LENDINGPOOL_ADDRESS: '0xE0fBa4Fc209b4948668006B2bE61711b7f465bAe'
}, _Market$Proto[Network.ropsten] = {
  LENDINGPOOL_ADDRESS: ''
}, _Market$Proto[Network.mainnet] = {
  LENDINGPOOL_ADDRESS: '0x7d2768dE32b0b80b7a3454c06BdAc94A69DDc7A9'
}, _Market$Proto[Network.polygon] = {
  LENDINGPOOL_ADDRESS: '0x8dFf5E27EA6b7AC08EbFdf9eB090F32ee9a30fcf'
}, _Market$Proto[Network.mumbai] = {
  LENDINGPOOL_ADDRESS: '0x9198F13B08E299d85E096929fA9781A1E3d5d827'
}, _Market$Proto), _distinctContractAddr[Market.AMM] = (_Market$AMM = {}, _Market$AMM[Network.kovan] = {
  LENDINGPOOL_ADDRESS: '0x762E2a3BBe729240ea44D31D5a81EAB44d34ef01'
}, _Market$AMM[Network.ropsten] = {
  LENDINGPOOL_ADDRESS: ''
}, _Market$AMM[Network.mainnet] = {
  LENDINGPOOL_ADDRESS: '0x7937d4799803fbbe595ed57278bc4ca21f3bffcb'
}, _Market$AMM), _distinctContractAddr);
var aaveGovernanceV2Addresses = (_aaveGovernanceV2Addr = {}, _aaveGovernanceV2Addr[Network.kovan] = {
...
}, _aaveGovernanceV2Addr[Network.polygon] = {
  AAVE_GOVERNANCE_V2: '',
  AAVE_GOVERNANCE_V2_EXECUTOR_SHORT: '',
  AAVE_GOVERNANCE_V2_EXECUTOR_LONG: '',
  AAVE_GOVERNANCE_V2_HELPER: ''
}, _aaveGovernanceV2Addr[Network.mumbai] = {
  AAVE_GOVERNANCE_V2: '',
  AAVE_GOVERNANCE_V2_EXECUTOR_SHORT: '',
  AAVE_GOVERNANCE_V2_EXECUTOR_LONG: '',
  AAVE_GOVERNANCE_V2_HELPER: ''
...
var distinctStakingAddressesBetweenTokens = (_distinctStakingAddre = {}, _distinctStakingAddre[Stake.Aave] = (_Stake$Aave = {}, _Stake$Aave[Network.kovan] = {
  canUsePermit: true,
...
}, _Stake$Aave[Network.ropsten] = {
  canUsePermit: false,
  TOKEN_STAKING_ADDRESS: '',
  STAKING_REWARD_TOKEN_ADDRESS: '',
  STAKING_HELPER_ADDRESS: ''
}, _Stake$Aave[Network.mainnet] = {
  canUsePermit: true,
...
}, _Stake$Aave[Network.polygon] = {
  canUsePermit: false,
  TOKEN_STAKING_ADDRESS: '',
  STAKING_REWARD_TOKEN_ADDRESS: '',
  STAKING_HELPER_ADDRESS: ''
}, _Stake$Aave[Network.mumbai] = {
  canUsePermit: false,
  TOKEN_STAKING_ADDRESS: '',
  STAKING_REWARD_TOKEN_ADDRESS: '',
  STAKING_HELPER_ADDRESS: ''
}, _Stake$Aave), _distinctStakingAddre[Stake.Balancer] = (_Stake$Balancer = {}, _Stake$Balancer[Network.kovan] = {
  canUsePermit: false,
  TOKEN_STAKING_ADDRESS: '0x31ce45Ab6E26C72c47C52c27498D460099545ef2',
  STAKING_REWARD_TOKEN_ADDRESS: '0xb597cd8d3217ea6477232f9217fa70837ff667af',
  STAKING_HELPER_ADDRESS: ''
}, _Stake$Balancer[Network.ropsten] = {
  canUsePermit: false,
  TOKEN_STAKING_ADDRESS: '',
  STAKING_REWARD_TOKEN_ADDRESS: '',
  STAKING_HELPER_ADDRESS: ''
}, _Stake$Balancer[Network.mainnet] = {
  canUsePermit: false,
  TOKEN_STAKING_ADDRESS: '0xa1116930326D21fB917d5A27F1E9943A9595fb47',
  STAKING_REWARD_TOKEN_ADDRESS: '0x7fc66500c84a76ad7e9c93437bfc5ac33e2ddae9',
  STAKING_HELPER_ADDRESS: ''
}, _Stake$Balancer[Network.polygon] = {
  canUsePermit: false,
  TOKEN_STAKING_ADDRESS: '',
  STAKING_REWARD_TOKEN_ADDRESS: '',
  STAKING_HELPER_ADDRESS: ''
}, _Stake$Balancer[Network.mumbai] = {
  canUsePermit: false,
  TOKEN_STAKING_ADDRESS: '',
  STAKING_REWARD_TOKEN_ADDRESS: '',
  STAKING_HELPER_ADDRESS: ''
...
var enabledNetworksByService = {
  staking: (_staking = {}, _staking[Stake.Balancer] = [Network.kovan, Network.mainnet], _staking[Stake.Aave] = [Network.kovan, Network.mainnet], _staking),
  lendingPool: (_lendingPool = {}, _lendingPool[Market.Proto] = [Network.kovan, Network.mainnet, Network.polygon, Network.mumbai], _lendingPool[Market.AMM] = [Network.kovan, Network.mainnet], _lendingPool),
  governance: [Network.kovan, Network.mainnet],
  wethGateway: [Network.kovan, Network.mainnet, Network.polygon, Network.mumbai],
        ...
        while (1) {
          switch (_context8.prev = _context8.next) {
            ...
            case 6:
              ...
              if (!approved) {
                approveTx = this.erc20Service.approve(user, fromAToken, SWAP_COLLATERAL_ADAPTER, constants.MaxUint256.toString());
                txs.push(approveTx);
              }
        ...
        while (1) {
          switch (_context9.prev = _context9.next) {
            ...
            case 6:
              ...
              if (!approved) {
                approveTx = this.erc20Service.approve(user, fromAToken, REPAY_WITH_COLLATERAL_ADAPTER, constants.MaxUint256.toString());
                txs.push(approveTx);
              }
...
__decorate([StakingValidator, __param(0, IsEthAddress()), __param(1, IsPositiveAmount()), __metadata("design:type", Function), __metadata("design:paramtypes", [String, String, String]), __metadata("design:returntype", Promise)], StakingService.prototype, "signStaking", null);
...
var BaseTxBuilder = function BaseTxBuilder(network, injectedProvider, defaultProviderKeys) {
  ...
  this.getStaking = function (stake) {
    var stakeToken = stake || Stake.Aave;
  ...
  } else if (injectedProvider instanceof providers.Web3Provider || injectedProvider instanceof providers.StaticJsonRpcProvider) {
...
export { API_ETH_MOCK_ADDRESS, BigNumberZD, ChainId, DEFAULT_APPROVE_AMOUNT, DEFAULT_NULL_VALUE_ON_TX, ETH_DECIMALS, ExecutorType, GovernanceVote, HALF_RAY, HALF_WAD, InterestRate, LTV_PRECISION, MAX_UINT_AMOUNT, Market, Network, ProposalState, ProtocolAction, RAY, RAY_DECIMALS, SECONDS_PER_YEAR, SUPER_BIG_ALLOWANCE_NUMBER, SURPLUS, Stake, TxBuilder as TxBuilderV2, USD_DECIMALS, WAD, WAD_RAY_RATIO, aaveGovernanceV2Addresses, binomialApproximatedRayPow, calculateAvailableBorrowsETH, calculateAverageRate, calculateCompoundedInterest, calculateHealthFactorFromBalances, calculateHealthFactorFromBalancesBigUnits, calculateIncentivesAPY, calculateLinearInterest, calculateReserveDebt, calculateReserveDebtSuppliesRaw, calculateRewards, calculateSupplies, commonContractAddressBetweenMarketsV2, computeRawUserSummaryData$1 as computeRawUserSummaryData, computeUserReserveData$1 as computeUserReserveData, distinctContractAddressBetweenMarketsV2, distinctStakingAddressesBetweenTokens, eEthereumTxType, enabledNetworksByService, formatReserves$1 as formatReserves, formatUserSummaryData$1 as formatUserSummaryData, gasLimitRecommendations, getCompoundedBalance, getCompoundedStableBalance, getEthAndUsdBalance, getLinearBalance, getReserveNormalizedIncome, normalize, normalizeBN, pow10, rayDiv, rayMul, rayPow, rayToDecimal, rayToWad, uniswapEthAmount, index as v1, index$1 as v2, valueToBigNumber, valueToZDBigNumber, wadDiv, wadMul, wadToRay };
