...
class UiPoolDataProvider {
    ...
    async getUserReservesData(lendingPoolAddressProvider, user) {
        ...
        console.log(lendingPoolAddressProvider, user);
        const thing = (await this._contract.getUserReservesData(lendingPoolAddressProvider, user));
        console.log(thing);
    ...
    async getUserReservesHumanized(lendingPoolAddressProvider, user) {
        ...
        return {
            userReserves: userReservesRaw.map(userReserveRaw => ({
                ...
                stableBorrowLastUpdateTimestamp: 0 //userReserveRaw.stableBorrowLastUpdateTimestamp.toNumber(),
            })),
            userEmodeCategoryId,
        };
    }
