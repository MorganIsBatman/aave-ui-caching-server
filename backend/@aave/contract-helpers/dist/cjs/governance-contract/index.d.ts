...
import { GovGetProposalsType, GovGetProposalType, GovGetVotingAtBlockType, GovSubmitVoteType, GovGetTokensVotingPower as GovGetPower, GovGetVoteOnProposal, Proposal, Power, ProposalRPC, Vote } from './types';
